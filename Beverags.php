...
<?php include 'navbar.php'; ?>
  ...
  <div class="head">Showing Products Of <span style="color: red;">Beverages</span></div>

  <div class="products-pics">
    <img src="Beverages Pics/EnergyDrink.png" alt="">
  </div>

  <div class="home-tag">
    <a href="Home.html">Home</a> > <a href="Beverags.html">Beverages</a>
  </div>
  ...
  <div class="product-container">
    ...
    $query = "SELECT * FROM products WHERE category = 'Beverags'";
