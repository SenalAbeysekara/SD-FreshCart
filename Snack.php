...
<?php include 'navbar.php'; ?>
  ...
  <div class="head">Showing Products Of <span style="color: red;">Snacks & Confectionery</span></div>

  <div class="products-pics">
    <img src="Snacks Pics/astra.png" alt="">
  </div>

  <div class="home-tag">
    <a href="Home.html">Home</a> > <a href="Snack.html">Snacks & Confectionery</a>
  </div>
  ...
  <div class="product-container">
    ...
    $query = "SELECT * FROM products WHERE category = 'Snack'";
