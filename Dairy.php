...
<?php include 'navbar.php'; ?>
  ...
  <div class="head">Showing Products Of <span style="color: red;">Diary Products</span></div>

  <div class="products-pics">
    <img src="Diary Pics/MilkPowder.png" alt="">
  </div>

  <div class="home-tag">
    <a href="Home.html">Home</a> > <a href="Dairy.html">Diary Products</a>
  </div>
  ...
  <div class="product-container">
    ...
    $query = "SELECT * FROM products WHERE category = 'Dairy'";
